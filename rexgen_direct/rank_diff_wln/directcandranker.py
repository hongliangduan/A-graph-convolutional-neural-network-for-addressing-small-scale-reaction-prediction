    ...
    def predict(self, react, top_cand_bonds, top_cand_scores=[], scores=True, top_n=100):
        ...
        if scores:
            for i in range(min(len(cand_smiles), top_n)):
                outcomes.append({
                    'rank': i + 1,
                    'cand_smiles': cand_smiles[i],
                    'cand_score': cand_scores[i],
...
if __name__ == '__main__':
    ...
    # print("bond_preds are: ")
    # print(bond_preds)
    # print(len(bond_preds))
    #
    # print("bond_scores are: ")
    # print(bond_scores)
    # print(len(bond_scores))
    #
    # print("cur_att_score: ")
    # print(cur_att_score[0])
    # print(len(cur_att_score[0]))
    # print("cur_att_score: ")
    # print(cur_att_score[18])
    # print(len(cur_att_score[18]))
    # print(cur_att_score[19])
    # print(cur_att_score[20])
    # print(len(cur_att_score))
