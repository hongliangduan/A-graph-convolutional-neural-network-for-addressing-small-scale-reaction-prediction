...
def get_changed_bonds(rxn_smi):
    ...
    # products
    print("****************************************************************")
    print("For the products:")
    print(conserved_maps)
    print("****************************************************************")
    # for '[CH2:15]([CH:16]([CH3:17])[CH3:18])[Mg+:19].[CH2:20]1[O:21][CH2:22][CH2:23][CH2:24]1.[Cl-:14].[OH:1][c:2]1[n:3][cH:4][c:5]([C:6](=[O:7])[N:8]([O:9][CH3:10])[CH3:11])[cH:12][cH:13]1
    # >>[OH:1][c:2]1[n:3][cH:4][c:5]([C:6](=[O:7])[CH2:15][CH:16]([CH3:17])[CH3:18])[cH:12][cH:13]1',
    # get result like ['1', '2', '3', '4', '5', '6', '7', '15', '16', '17', '18', '12', '13']
    ...
    print("#################################################################")
    print("Previous bonds of reactants:")
    print(bonds_prev)
    print("#################################################################")
    # for '[CH2:15]([CH:16]([CH3:17])[CH3:18])[Mg+:19].[CH2:20]1[O:21][CH2:22][CH2:23][CH2:24]1.[Cl-:14].[OH:1][c:2]1[n:3][cH:4][c:5]([C:6](=[O:7])[N:8]([O:9][CH3:10])[CH3:11])[cH:12][cH:13]1
    # >>[OH:1][c:2]1[n:3][cH:4][c:5]([C:6](=[O:7])[CH2:15][CH:16]([CH3:17])[CH3:18])[cH:12][cH:13]1',
    # get: {'6~7': 2.0, '3~4': 1.5, '15~19': 1.0, '12~13': 1.5, '5~6': 1.0, '12~5': 1.5, '2~3': 1.5, '13~2': 1.5, '15~16': 1.0, '6~8': 1.0, '4~5': 1.5, '16~17': 1.0, '1~2': 1.0, '16~18': 1.0}
...
if __name__ == '__main__':
    ...
    # process_file('../data/map.txt')

    # Process files
    process_file('../data/map_train.txt')
    process_file('../data/map_valid.txt')
    process_file('../data/map_test.txt')
